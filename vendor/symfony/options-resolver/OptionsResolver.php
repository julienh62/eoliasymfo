...
class OptionsResolver implements Options
{
    ...
    {
        // CategoryColorSetting is not possible once resolving starts, because then lazy
    ...
    {
        throw new AccessException('CategoryColorSetting options via array access is not supported. Use setDefault() instead.');
    }
